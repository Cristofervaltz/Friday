...
class EditFileTool(BaseTool):
    ...
    def parameters_schema(self) -> dict[str, Any]:
        return {
            ...
            "properties": {
                ...
                "operation": {
                    "type": "string",
                    "enum": ["replace_lines", "insert_after", "delete_lines", "find_replace"],
                    "description": (
                        "Edit operation: "
    ...
    def execute(self, **kwargs: Any) -> ToolResult:
        ...
        try:
            ...
            return ToolResult(
                success=True,
                output=f"Successfully edited {file_path} ({operation})"
            )
    ...
    def _replace_lines(self, lines: list[str], kwargs: dict[str, Any]) -> ToolResult:
        ...
        if line_number is None:
            return ToolResult(
                success=False,
                error="Missing required parameter: line_number"
            )
    ...
    def _delete_lines(self, lines: list[str], kwargs: dict[str, Any]) -> ToolResult:
        ...
        if not line_numbers:
            return ToolResult(
                success=False,
                error="Missing required parameter: line_numbers"
            )
